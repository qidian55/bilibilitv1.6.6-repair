...
public final class afb extends adu implements aez, wf {
        ...
        this.a = new BorderGridLayoutManager(activity, i, i2, z) { // from class: com.bilibili.tv.ui.main.content.MainBangumiFragment$onViewCreated$1
            ...
            public View d(View view, int i3) {
                ...
                if (i3 != 33) {
                    ...
                    FragmentActivity activity2 = afb.this.getActivity();
                    if (activity2 == null) {
    ...
    final class a extends vm<BangumiMainEx> {
        ...
        public boolean isCancel() {
            return afb.this.getActivity() == null || afb.this.b == null;
        }

        @Override // bl.vm
        public void onError(Throwable th) {
            bbi.b(th, "t");
            adl.a.a(th, afb.this.getActivity());
        }
    }
    ...
    static final class b extends RecyclerView.a<adv> {
        ...
        public void a(adv advVar, int i) {
            ...
            if (advVar instanceof e) {
                ...
                BangumiMainEx.Content content = this.f.get(i - afb.f);
    ...
    static final class d extends adv implements View.OnClickListener, View.OnFocusChangeListener {
        ...
        private final WeakReference<afb> q;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public d(View view, WeakReference<afb> weakReference) {
            super(view);
            bbi.b(view, "itemView");
        ...
        public static final class a {
            ...
            public final d a(ViewGroup viewGroup, WeakReference<afb> weakReference) {
                bbi.b(viewGroup, "parent");
        ...
        public void onFocusChange(View view, boolean z) {
            bbi.b(view, "v");
            afb afbVar = this.q.get();
            Object tag = view.getTag(R.id.position);
            if (afbVar == null || tag == null) {
                return;
            }
            afbVar.d = ((Integer) tag).intValue();
            adj.a(view, z);
    ...
    static final class e extends adv implements View.OnClickListener, View.OnFocusChangeListener {
        ...
        private final WeakReference<afb> r;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public e(View view, WeakReference<afb> weakReference) {
            super(view);
            bbi.b(view, "itemView");
            bbi.b(weakReference, "mMainBangumiFragmentWeakReference");
        ...
        public static final class a {
            ...
            public final e a(ViewGroup viewGroup, WeakReference<afb> weakReference) {
                bbi.b(viewGroup, "parent");
                bbi.b(weakReference, "weakReference");
