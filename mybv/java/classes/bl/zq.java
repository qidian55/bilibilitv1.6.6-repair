...
public class zq {
    public static void a(String str, int i, String str2, String str3, int i2, long i3, int i4, boolean z, int i5, int i6, int i7, String str4) {
    ...
    public static void a(Context context, long i, int i2, long j, long j2, int i3, long j3, long j4) {
